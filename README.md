...
## Что реализовано по **Заданию #4** Урок 4: Способы взаимодейтсвия с пользователем:

- Реализован **REST-интерфейс** на **FastAPI**, покрывающий весь базовый функционал системы.
  - Регистрация и авторизация
  - Просмотр и пополнение баланса
  - Отправка запроса на выполнение предсказания биологического возвраста
...
- **Эндпоинты**:
  ...
  - POST /api/tasks/predict — shortcut: создать и выполнить задачу
